...
function Footer() {
  return (
    <div className="w-full h-screen flex items-center p-15">
      <div className="flex flex-col justify-between w-1/2 h-full tracking-tighter">
        <div>
          <h1 className="text-[6vw] -mb-12 font-semibold">EYE-</h1>
          <h1 className="text-[6vw] -mb-12 font-semibold">OPENING</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 h-full tracking-tighter">
